              ...
              <div className="ml-auto max-w-md text-right">
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="rounded-xl bg-[#ffe08f] px-7 py-4 text-sm font-bold uppercase tracking-[0.12em] text-slate-950 shadow-[0_14px_30px_rgba(143,214,255,0.35)] transition hover:bg-[#e8b42c]"
                  >
                    לצפייה בשיעורים
                  </button>
                </div>
