  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-4 pb-4 sm:pb-6">
      <div className="mx-auto max-w-xl">
        <div
          className="absolute inset-x-0 bottom-0 h-44 bg-[radial-gradient(circle_at_center,rgba(15,23,42,0.22),rgba(15,23,42,0.08)_60%,transparent_100%)] backdrop-blur-[3px]"
